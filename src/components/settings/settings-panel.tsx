    ...
    return (
        <div className="space-y-6">
            ...
            <section className="rounded-3xl border border-border/50 bg-muted/40 p-6">
                ...
                <div className="mt-5 rounded-2xl border border-destructive/30 bg-destructive/5 p-4 flex flex-col gap-3">
                    <div className="text-[10px] font-black uppercase tracking-widest text-destructive/80">Destructive Actions</div>
            ...
            <section className="rounded-3xl border border-border/50 bg-muted/40 p-6">
                ...
                <div className="mt-4 space-y-3 rounded-2xl border border-destructive/40 bg-destructive/10 p-4">
                    ...
                    <input
                        ...
                        autoComplete="email"
                    />
                    {deleteConfirmStep && !deleteError && (
                        <div className="flex items-center gap-2 rounded-lg border border-destructive/40 bg-destructive/10 px-3 py-2">
                            <AlertTriangle className="w-3.5 h-3.5 text-destructive shrink-0" />
                            <p className="text-[11px] font-semibold text-destructive">This is permanent and cannot be undone. Click again to confirm.</p>
                        </div>
                    )}
                    {deleteError && (
                    ...
                    >
                        {isDeleting ? 'Deleting...' : deleteConfirmStep ? 'Yes, permanently delete my account' : 'Delete Account'}
                    </Button>
                </div>
            </section>
