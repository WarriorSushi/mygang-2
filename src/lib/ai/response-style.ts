const CORRECTION_TURN_PATTERN = /\b(did you (read|hear|see)|i just (said|told)|pay attention|what i said|are you listening|listen to what i said)\b/i
const CLARIFICATION_TURN_PATTERN = /\b(let me be clear|to be clear|what i mean is|what i'm saying is|read that again|i meant|that's not what i said|you missed the point|you missed what i said|you'?re not getting it)\b/i
