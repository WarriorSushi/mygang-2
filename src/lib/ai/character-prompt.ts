...
const TYPING_STYLES: Record<string, string> = {
    ...
    vee: 'Proper caps. Precise language. "Actually/technically" openers. Medium-long. Factual tone.',
...
const CHARACTER_DEPTH: Record<string, string> = {
    ...
    vee: 'Corrects people because being wrong once cost her something real. Facts are her safe space.',
