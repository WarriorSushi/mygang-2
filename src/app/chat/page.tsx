    ...
    return (
        <main id="main-content" className="flex flex-col h-dvh bg-background text-foreground overflow-hidden relative isolate">
            ...
            <div ref={captureRootRef} className="flex-1 flex flex-col w-full relative min-h-0 z-10">
                ...
                <div className="shrink-0 relative z-20 border-t border-border/40 bg-background/90 px-4 pt-2 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] backdrop-blur-xl supports-[backdrop-filter]:bg-background/75">
                    {!isOnline && (
